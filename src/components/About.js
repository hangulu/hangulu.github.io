    ...
    <Fragment>
      <Container text>
        <div className={aboutClass}>
          ...
          <p>
            I am currently based in Brooklyn, NY. I am a Software Engineer III
            at Google, on their Counter-Abuse Technology team. I am also the
            ...
            making natural hair accessible using science and technology.
          </p>
          <p>
            I have two primary passions: art and code. This website aims to be a
            showcase of those two things, both separately and as one. I document
            here my own artwork (mostly photography) and my own coding projects,
            many of which have the explicit aim to amplify voices, facilitate
