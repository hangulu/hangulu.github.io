    ...
    <Fragment>
      <Container text>
        <div className={aboutClass}>
          ...
          <p>I am currently based in Cambridge, MA. I am a Software Engineer at Google, on their News team. I am also the Chief Technology Officer of <a href="https://myoaksystem.com/" target="_blank" rel="noopener noreferrer">oak</a>, a startup committed to uplifting Black-owned hair businesses and making natural hair accessible using science and technology.</p>
