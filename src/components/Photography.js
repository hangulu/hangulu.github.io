          ...
          <Grid stackable columns={16}>
            <Grid.Row centered>
              <Grid.Column width={16}>
                <Image src={portfolio1} size="massive" />
              </Grid.Column>
            </Grid.Row>

            <Grid.Row>
              <Grid.Column width={8}>
                <Image src={portfolio7} size="large" />
              </Grid.Column>
              <Grid.Column width={8}>
                <Image src={portfolio3} size="large" />
              </Grid.Column>
            </Grid.Row>

            <Grid.Row centered>
              <Grid.Column width={16}>
                <Image src={portfolio4} size="massive" />
              </Grid.Column>
            </Grid.Row>

            <Grid.Row>
              <Grid.Column width={8}>
                <Image src={portfolio5} size="large" />
              </Grid.Column>
              <Grid.Column width={8}>
                <Image src={portfolio6} size="large" />
              </Grid.Column>
            </Grid.Row>

            <Grid.Row centered>
              <Grid.Column width={16}>
                <Image src={portfolio2} size="massive" />
              </Grid.Column>
            </Grid.Row>
          </Grid>
