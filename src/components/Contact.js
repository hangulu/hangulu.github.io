...
import { Button, Container, Form, Header, Message, Popup } from 'semantic-ui-react';
...
export default function Contact({ mobile }) {
  ...
  const fieldsFilled = () => name.length > 0 && emailRe.test(email) && withinWordCount(subject, 15) && withinWordCount(message, 150)
    ...
    <Fragment>
      <Container text>
        <div className={contactClass}>
          ...
          <br/>
          <p>If you'd like to get in touch with me, please use the form below. I'll do my best to respond promptly.
          </p>
          <br/>
          <Form
            success={formSuccess}
